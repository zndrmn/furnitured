...
public class StraightKitchenCounterBlock extends Block {
    ...
    private static final VoxelShape SHAPE_EAST  = VoxelShapes.combineAndSimplify(
            Block.createCuboidShape(0, 12, 0, 16, 16, 16),
            Block.createCuboidShape(0, 0, 0, 15, 12, 16),
            BooleanBiFunction.OR);

    private static final VoxelShape SHAPE_SOUTH = VoxelShapes.combineAndSimplify(
            Block.createCuboidShape(0, 12, 0, 16, 16, 16),
            Block.createCuboidShape(0, 0, 0, 16, 12, 15),
            BooleanBiFunction.OR);
    ...
    public StraightKitchenCounterBlock(Settings settings) {
        super(settings);
